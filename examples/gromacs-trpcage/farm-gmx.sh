...
#
#   ./farm-gmx.sh --check         # run shape and readiness; writes nothing
#   ./farm-gmx.sh --dry-run       # dirs, configs, job scripts; submits nothing
...
# farmer.py: `./farm-gmx.sh start --n-gens 1`.
set -euo pipefail
